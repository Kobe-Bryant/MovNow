...
NSString *const MJRefreshHeaderStateIdleText = @"下拉可以同步";
NSString *const MJRefreshHeaderStatePullingText = @"松开立即同步";
NSString *const MJRefreshHeaderStateRefreshingText = @"正在同步数据";
